...
def guardar_persona():
    try:
        ...
        controlador_persona.insertar_persona(
            dni, nombres, ape_paterno, ape_materno, fecha_nacimiento,
            telefono, direccion, ubigeo
        )
...
def actualizar_persona():
    try:
        ...
        controlador_persona.actualizar_persona(
            dni, nombres, ape_paterno, ape_materno,
            fecha_nacimiento, telefono, direccion, ubigeo, id_persona
        )
...
@app.route("/ciudadano/buscar/<string:dni>/<string:nombre>/json", methods=["POST"])
@login_required
def api_buscar_persona(dni,nombre):
    try:
